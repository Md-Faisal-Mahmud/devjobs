...
set mainProject=../src/DevJobs.Api

:: Defined Other DbContext Here 
set dbcontext[0]=ApplicationDbContext
set dbcontext[1]=EmailMessagingContext


:: Don't modify in the below

title DevJobs Migration Runner
set /a dbcontextSize=0
set migrationdirectory=Migrations
...
if %options% gtr %ddd% goto :WrongInput
echo:
set /p args="Enter migration name (Hint: "InitialMigration"): "
set /a index=%options%-1
echo:
